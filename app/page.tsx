            ...
            <div className="mb-16">
              ...
              <nav>
                <ul className="flex flex-col gap-2">
                  ...
                  <li>
                    <span className="inline-flex w-full flex-col justify-between gap-2 whitespace-nowrap rounded-lg border border-input bg-background p-4 text-sm font-bold shadow-sm shadow-black/[0.04] sm:h-14 sm:flex-row sm:items-center">
