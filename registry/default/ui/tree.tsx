...
function TreeDragLine({
  ...
  return <div 
    style={dragLine} 
    className={cn("absolute -mt-px h-0.5 w-[unset] bg-primary z-30 before:absolute before:left-0 before:-top-[3px] before:size-2 before:bg-background before:border-2 before:border-primary before:rounded-full", className)}
    {...props}
  />
}
