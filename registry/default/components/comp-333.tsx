    ...
    <>
      ...
      >
        <span className="flex grow items-center">
          <Search className="text-muted-foreground/80 -ms-1 me-3" size={16} aria-hidden="true" />
      ...
      <CommandDialog open={open} onOpenChange={setOpen}>
        ...
        <CommandList>
          ...
          <CommandGroup heading="Quick start">
            ...
            <CommandItem>
              <FileInput size={16} className="opacity-60" aria-hidden="true" />
              <span>Import document</span>
              <CommandShortcut className="justify-center">⌘I</CommandShortcut>
            </CommandItem>
            <CommandItem>
              <CircleFadingPlus size={16} className="opacity-60" aria-hidden="true" />
              <span>Add block</span>
