  ...
  return (
    <DateRangePicker className="*:not-first:mt-2">
      ...
      <div className="flex">
        ...
        <Button className="text-muted-foreground/80 hover:text-foreground outline-ring/30 dark:outline-ring/40 z-10 -ms-9 -me-px flex w-9 items-center justify-center rounded-e-md outline-offset-2 transition-colors">
