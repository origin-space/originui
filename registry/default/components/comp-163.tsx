...
export default function Component() {
  ...
  return (
    <RadioGroup className="grid-cols-3" defaultValue="1">
      {/* Credit card */}
      <label className="relative flex cursor-pointer flex-col items-center gap-3 rounded-lg border border-input px-2 py-3 text-center shadow-xs shadow-black/5 outline-offset-2 transition-colors has-data-[state=checked]:border-ring has-data-[state=checked]:bg-accent has-focus-visible:outline has-focus-visible:outline-2 has-focus-visible:outline-ring/70">
