...
export default function Component() {
  ...
  return (
    <RadioGroup className="gap-2" defaultValue="1">
      {/* Radio card #1 */}
      <div className="border-input has-data-[state=checked]:border-ring relative flex w-full items-start gap-2 rounded-lg border p-4 shadow-xs">
        <RadioGroupItem
          value="1"
          id={`${id}-1`}
      ...
      {/* Radio card #2 */}
      <div className="border-input has-data-[state=checked]:border-ring relative flex items-center gap-2 rounded-lg border p-4 shadow-xs">
        <RadioGroupItem
          value="2"
          id={`${id}-2`}
