        ...
        {items.map((item) => (
          <label key={`${id}-${item.value}`}>
            ...
            <img
              ...
              width={88}
              height={70}
              className="border-input peer-focus-visible:ring-ring/50 peer-focus-visible:ring-[3px] peer-data-[state=checked]:border-ring peer-data-[state=checked]:bg-accent relative cursor-pointer overflow-hidden rounded-md border shadow-xs transition-[color,box-shadow] outline-none peer-data-disabled:cursor-not-allowed peer-data-disabled:opacity-50"
            />
