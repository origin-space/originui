        ...
        {items.map((item) => (
          <label key={`${id}-${item.value}`}>
            ...
            <img
              ...
              width={88}
              height={70}
              className="border-input peer-focus-visible:outline-ring/70 peer-data-[state=checked]:border-ring peer-data-[state=checked]:bg-accent relative cursor-pointer overflow-hidden rounded-lg border shadow-xs outline-offset-2 transition-colors peer-focus-visible:outline-2 peer-data-disabled:cursor-not-allowed peer-data-disabled:opacity-50"
            />
