  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div
        ...
        className="rounded-xl flex flex-col items-center justify-center border border-dashed border-input not-has-disabled:hover:bg-accent/50 transition-colors p-4 data-[dragging=true]:bg-accent/50 has-[input:focus]:border-ring has-[input:focus]:ring-ring/50 has-[input:focus]:ring-[3px]"
      >
