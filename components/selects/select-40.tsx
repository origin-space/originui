  ...
  return (
    <div className="space-y-2">
      ...
      <div className="overflow-hidden rounded-lg border border-input">
        <ListBox className="bg-background shadow-sm shadow-black/5 ring-offset-background transition-shadow p-1 text-sm space-y-1" aria-label="Select framework" selectionMode="single" defaultSelectedKeys={["svelte"]}>
