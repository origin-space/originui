...
export default function Select43() {
  return (
    <div className="space-y-2">
      <Label htmlFor="select-43">Options with avatar</Label>
      <Select defaultValue="s1">
        <SelectTrigger id="select-43" className="[&>span]:flex [&>span]:items-center [&>span]:gap-2 [&>span_img]:shrink-0 ps-2">
        ...
        <SelectContent className="[&_*[role=option]]:pe-8 [&_*[role=option]]:ps-2 [&_*[role=option]>span]:flex [&_*[role=option]>span]:gap-2 [&_*[role=option]>span]:items-center [&_*[role=option]>span]:start-auto [&_*[role=option]>span]:end-2">
          <SelectGroup>
            ...
            <SelectItem value="s1">
              <Image className="size-5 rounded" src={Avatar01} alt="Frank Allison" width={20} height={20} />
              <span className="truncate">Jenny Hamilton</span>
            </SelectItem>
            <SelectItem value="s2">
              <Image className="size-5 rounded" src={Avatar02} alt="Xavier Guerra" width={20} height={20} />
              <span className="truncate">Paul Smith</span>
            </SelectItem>
            <SelectItem value="s3">
              <Image className="size-5 rounded" src={Avatar03} alt="Anne Kelley" width={20} height={20} />
