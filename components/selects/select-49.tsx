...
export default function Select49() {
  return (
    <div className="space-y-2">
      <Label htmlFor="select-49">Options with portrait</Label>
      <Select defaultValue="s1">
        <SelectTrigger id="select-49" className="h-auto [&>span]:flex [&>span]:items-center [&>span]:gap-2 [&>span_img]:shrink-0 ps-2">
