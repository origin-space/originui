...
export default function Checkbox12() {
  return (
    <div className="relative flex items-start space-x-2 space-x-reverse rounded-lg border border-input p-4 shadow-sm shadow-black/[.04] has-[[data-state=checked]]:border-muted-foreground">
      <Checkbox
        id="checkbox-12"
