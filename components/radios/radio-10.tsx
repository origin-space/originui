  ...
  return (
    <RadioGroup className="gap-2" defaultValue="r1">
      ...
      <div className="relative items-top flex space-x-2 space-x-reverse p-4 border border-input rounded-lg shadow-sm shadow-black/[.04] has-[[data-state=checked]]:border-muted-foreground">
        <RadioGroupItem value="r1" id="radio-10-r1" aria-describedby="radio-10-r1-description" className="order-1 after:absolute after:inset-0" />
      ...
      {/* Radio card #2 */}
      <div className="relative items-top flex space-x-2 space-x-reverse p-4 border border-input rounded-lg shadow-sm shadow-black/[.04] has-[[data-state=checked]]:border-muted-foreground">
        <RadioGroupItem value="r2" id="radio-10-r2" aria-describedby="radio-10-r2-description" className="order-1 after:absolute after:inset-0" />
        <div className="grow flex items-start gap-3">
          <svg 
            className="shrink-0"
            xmlns="http://www.w3.org/2000/svg" 
            ...
            aria-hidden="true"
          >
            <circle cx="16" cy="16" r="16" fill="#090A15"/><path fill="#fff" fillRule="evenodd" d="M8.004 19.728a.996.996 0 0 1-.008-1.054l7.478-12.199a.996.996 0 0 1 1.753.104l6.832 14.82a.996.996 0 0 1-.618 1.37l-10.627 3.189a.996.996 0 0 1-1.128-.42l-3.682-5.81Zm8.333-9.686a.373.373 0 0 1 .709-.074l4.712 10.904a.374.374 0 0 1-.236.506L14.18 23.57a.373.373 0 0 1-.473-.431l2.63-13.097Z" clipRule="evenodd"/>
          </svg>     
          <div className="grow grid gap-1">
