...
export default function Banner20() {
  ...
  return (
    <div className="px-4 py-3 bg-blue-400 bg-opacity-20 dark:bg-opacity-10 text-blue-700 dark:text-blue-600">
      <div className="flex gap-2">
        ...
        <Button
          variant="ghost"
          className="shrink-0 -me-2 -my-1.5 p-0 size-8 hover:bg-transparent hover:text-current group focus-visible:ring-blue-400/50 !ring-offset-0"
