...
export default function Banner20() {
  ...
  return (
    <div className="px-4 py-3 md:py-2 bg-indigo-500 text-foreground dark">
      <div className="flex gap-2 md:items-center">
        <div className="grow flex gap-2 md:items-center">
          ...
          <div className="grow flex flex-col md:flex-row justify-between md:items-center gap-3">
            ...
            <div className="flex max-md:flex-wrap gap-2">
              <Button size="sm" className="focus-visible:ring-foreground/30 !ring-offset-0">Download</Button>
              <Button
                variant="link"
                size="sm"
                className="focus-visible:ring-foreground/30 !ring-offset-0"
              >
                Learn more
              </Button>
            </div>
        ...
        <Button
          variant="ghost"
          className="shrink-0 -me-2 -my-1.5 p-0 size-8 hover:bg-transparent group focus-visible:ring-foreground/30 !ring-offset-0"
